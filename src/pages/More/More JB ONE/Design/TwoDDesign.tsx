...
const TwoDDesignsPage: React.FC = () => {
    const [search, setSearch] = useState("");

    return (
        <PageLayout
            header={<Header title="2D Design" type="page" showRightIcon={false} />}
        >
            <IonContent >
                {/* Search Header */}
...
export default TwoDDesignsPage;
